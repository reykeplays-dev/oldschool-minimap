...
Before any exploration begins with the party, if the GM is setting this up ahead of time, they are able to export the floor plan to their local device storage for later import. So if you are truly a prepper you could essentially plan as many floors of your dungeon as you want and save them and then just load them in sequence as the party moves through the floors.
